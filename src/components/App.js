...
//make reducer to process action
const myReducer = (state = intiState, action) => {
  switch (action.type) {
    case "SHOW_ALL":
      return {
        ...state,
...
//tich hop vao trong ung dung react Provider -> co 1 props -> store
